...
CONFIG = {
    "API_KEY": _env("API_KEY", "sk-your-apikey"),  # API Key（必填，在 .env 中设置 AICHAT_API_KEY=sk-xxx）
...
WHITELIST_FILE = _env("WHITELIST_FILE", os.path.join(_PLUGIN_DIR, "whitelist.json"))  # type: ignore
BLACKLIST_FILE = _env("BLACKLIST_FILE", os.path.join(_PLUGIN_DIR, "blacklist.json"))  # type: ignore
STATS_FILE = _env("STATS_FILE", os.path.join(_PLUGIN_DIR, "stats.json"))  # type: ignore
BANWORDS_FILE = _env("BANWORDS_FILE", os.path.join(_PLUGIN_DIR, "banwords.json"))  # type: ignore
PERSONA_FILE = _env("PERSONA_FILE", os.path.join(_PLUGIN_DIR, "persona_state.json"))  # type: ignore
TOKEN_DAILY_FILE = os.path.join(_PLUGIN_DIR, "token_daily.json")
SPLIT_STATE_FILE = os.path.join(_PLUGIN_DIR, "split_state.json")
PERSONA_PROMPTS_FILE = os.path.join(_PLUGIN_DIR, "persona_prompts.json")
